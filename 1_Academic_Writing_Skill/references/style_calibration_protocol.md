...
- **Primary entry point**: `style-profile` or `polish-with-profile` mode in this skill (optional)
- **Portable carry**: save the result as `STYLE_PROFILE.md` in the requested output or reusable profile location
- **Consumers**: any drafting or polishing agent that reads this skill and the Style Profile
...
Combine the 6 dimensions into a **Style Profile** artifact (see `style_profile_schema.md`).
